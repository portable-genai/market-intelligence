"""Platform ReviewRouterPort: submit the routed brief review to human-review-console via
``review-kit``.

Builds the review from the escalated brief and submits it to the human-review-console service intake
(``POST /v1/service/reviews``), S2S-authenticated. The human-review-console base URL comes from
...
class PlatformReviewRouter:
    """Submit escalated market briefs to human-review-console (rule R8), reusing the shared S2S
    envs.
    """
    ...
    def route(  # pragma: no cover - needs live human-review-console
