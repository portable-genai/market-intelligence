"""Cloud Trace tracer adapter (ObservabilityTracerPort) — GCP managed stack for D1.
...
counts) ever land on a span, never the prompt, the retrieved passages or the model response.
...
_INSTRUMENTATION_SCOPE = "market_intelligence.tracing"
_SERVICE = "market-intelligence"
