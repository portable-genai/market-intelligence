...
let a consequential brief bypass human review (P-06, rule R8), so porting on-premise *must* supply a
real hand-off to the sovereign review console. Filling this body in is the only change required.
"""
