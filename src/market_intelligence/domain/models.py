...
class LlmRequest:
    ...
    # None samples freely and the adapter OMITS the parameter (some models reject it). A call
    # site pins 0.0 only where the output is extracted, classified, scored or compared.
