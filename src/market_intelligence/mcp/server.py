"""Serve the governed tool catalog creative-studio already declares, over MCP 2026-07-28.
...
def build_server(actor: str, *, with_audit_tools: bool = True) -> Any:
    """Build the MCP server for creative-studio's catalog, refusing on any
