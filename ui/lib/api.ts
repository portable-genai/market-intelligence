...
// The literal member expression is required: a bundler substitutes the public value only
// where it sees exactly this, and handing it `process.env` leaves the browser reading {}.
