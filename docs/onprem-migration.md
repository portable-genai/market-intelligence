...
The whole point of the ports-and-adapters shape is that Mkt1's exit story is **demonstrable,
...
To run Mkt1 on a sovereign / on-premise platform, implement these adapter bodies (the only
files that change):
