...
def build_spec() -> PluginSpec:
    ...
    from market_intelligence.adapters.gcp.mcp_tool_catalog import McpToolCatalogAdapter
    from market_intelligence.agent.agent_card import agent_card_document
    ...
    return PluginSpec(
        ...
        license="Apache-2.0",
        repository="https://github.com/portable-genai/market-intelligence",
        ...
        servers={
            "market-intelligence": StdioServer(
                command="python",
                args=("-m", "market_intelligence.mcp"),
                cwd="${PLUGIN_ROOT}",
            )
        },
