...
from market_intelligence.adapters.gcp.iap_identity import (
...
from market_intelligence.ports.identity import EndUserAuthUnavailableError
...
def test_the_transport_facts_are_the_commons_values() -> None:
    ...
    """
    from market_intelligence.adapters.gcp import iap_identity
...
def test_the_api_answers_a_deployment_failure_with_its_own_status_and_message(
    ...
    from market_intelligence.api import security
