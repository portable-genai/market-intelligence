...
from market_intelligence.adapters.gcp.iap_identity import IapIdentityAdapter
...
def _adapter_module() -> object:
    ...
    return importlib.import_module("market_intelligence.adapters.gcp.iap_identity")
